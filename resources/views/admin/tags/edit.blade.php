                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('tags.update', ['tag' => $tag->id]) }}" method="POST"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control"
                                            placeholder="Nhập tên chủ đề bài viết" value="{{ $tag->title }}">
                                        @error('title')
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <img width="200" src="{{ asset($tag->image) }}" alt="{{ $tag->title }}">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Mô tả chủ đề bài viết</label>
                                        <textarea rows="5" name="description" class="form-control" placeholder="Nhập Mô tả chủ đề bài viết">{{ $tag->description }}</textarea>
                                        @error('description')
                                            <div class="help-block with-errors text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
